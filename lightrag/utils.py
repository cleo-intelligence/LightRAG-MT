...
# Context variable for tracking tokens in the current document processing context
# Used to pass TokenTracker to embedding functions without modifying VDB class signatures
current_token_tracker: contextvars.ContextVar["TokenTracker | None"] = (
    contextvars.ContextVar("current_token_tracker", default=None)
)
